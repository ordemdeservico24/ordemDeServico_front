        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-[#3b82f6] text-2xl font-bold">Tertiary Groups</CardTitle>
                <CardDescription>Cheque todas as informações relacionadas aos grupos terciários.</CardDescription>
              </div>
              <Button variant="default" className="bg-blue-500 hover:bg-blue-600">
                Criar Novo Grupo Terceário
              </Button>
            </div>
          </CardHeader>
          <div>
              ...
              <Table className="overflow-x-auto">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableCell>ID do Grupo Secundário</TableCell>
                ...
                <TableBody>
                {Array.isArray(tertiaryGroups) && tertiaryGroups.map((group) => (
                    <TableRow key={group.id}>
                      <TableCell>{group.id}</TableCell>
                      <TableCell>{group.districtName}</TableCell>
                      <TableCell>{group.secondaryGroupId}</TableCell>
                      <TableCell>{group.users?.length || 0} usuários</TableCell>
                      <TableCell>{group.orders?.length || 0} pedidos</TableCell>
                      <TableCell>{group.subjects?.length || 0} assuntos</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
