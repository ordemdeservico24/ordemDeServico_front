						...
						<CardContent className="p-6 space-y-6">
							...
							<div className="mb-4">
								...
								<ul className="space-y-2">
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Funções: ${
											firmData.roles?.length || 0
										}`}</span>
									</li>
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Ordens: ${
											firmData.Order?.length || 0
										}`}</span>
									</li>
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Equipes: ${
											firmData.Team?.length || 0
										}`}</span>
									</li>
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Usuários: ${
											firmData.User?.length || 0
										}`}</span>
									</li>
								</ul>
							</div>
							...
							<div className="mb-4">
								...
								<ul className="space-y-2">
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Grupos Primários: ${
											firmData.primaries?.length || 0
										}`}</span>
									</li>
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Grupos Secundários: ${
											firmData.secondaries?.length || 0
										}`}</span>
									</li>
									<li>
										<span className="text-sm sm:text-base lg:text-xl font-semibold">{`Grupos Terciários: ${
											firmData.tertiaries?.length || 0
										}`}</span>
									</li>
								</ul>
							</div>
