...
export default function Page() {
	...
	const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
		...
		const getInput = (
			...
			return e.currentTarget.querySelector(`[name="${name}"]`) as
				| HTMLInputElement
				| HTMLSelectElement;
		};
	...
	const availableLeaders = Array.isArray(leaders)
		? leaders.filter((leader) => !leader.teamId)
		: [];
